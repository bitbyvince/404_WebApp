...
export const fetchHeatmap = async ({ period = "monthly", snapshot_date, barangay_id } = {}) => {
...
export const fetchHeatmapHistory = async (barangayId, { period = "monthly", from, to, limit = 12 } = {}) => {
