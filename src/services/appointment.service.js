...
export const fetchBarangayAppointments = async (barangay_id, { status, purpose, date } = {}) => {
...
export const fetchAllAppointments = async ({ status, purpose, from, to, barangay_id, page = 1, limit = 20 } = {}) => {
